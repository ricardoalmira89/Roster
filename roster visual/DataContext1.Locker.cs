...
namespace roster_visual
{
    ...
    public partial class Locker : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Locker_Student", Storage="_Student", ThisKey="Id", OtherKey="LockerId", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]

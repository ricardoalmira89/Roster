...
namespace roster_visual
{
    ...
    public partial class Student : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"cv", Storage = "_Cv", CanBeNull = false, DbType = "", UpdateCheck = UpdateCheck.Never)]
        public string Cv
        {
            get
            {
        ...
        /// </summary>
        [Column(Name = @"picture", Storage = "_Picture", DbType = "LongBlob", UpdateCheck = UpdateCheck.Never)]
        public byte[] Picture
        {
            get
            {

...
namespace roster_visual
{
    ...
    public partial class Student : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_EO", DbType = "VARCHAR(255) NULL", UpdateCheck = UpdateCheck.Never)]
        public string EO
        {
            get
            {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Student_StudentSchedule", Storage="_StudentSchedules", ThisKey="Id", OtherKey="StudentId", DeleteRule="CASCADE")]

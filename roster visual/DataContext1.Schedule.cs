...
namespace roster_visual
{
    ...
    public partial class Schedule : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"slug", Storage = "_Slug", CanBeNull = false, DbType = "VARCHAR(10) NOT NULL", IsPrimaryKey = true)]
        public string Slug
        {
            get
            {
        ...
        /// </summary>
        [Column(Name = @"program_id", Storage = "_ProgramId", DbType = "INT(11) NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        public Program Program
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Program.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._ProgramId = default(System.Nullable<int>);
                    }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Schedule_StudentSchedule", Storage="_StudentSchedules", ThisKey="Id", OtherKey="ScheduleId", DeleteRule="CASCADE")]

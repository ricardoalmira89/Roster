...
namespace roster_visual
{
    ...
    public partial class RosterMysqlDataContext : Devart.Data.Linq.DataContext
    {
        ...
        partial void InsertStudentProgram(StudentProgram instance);
        partial void UpdateStudentProgram(StudentProgram instance);
        partial void DeleteStudentProgram(StudentProgram instance);
        ...
        public Devart.Data.Linq.Table<StudentProgram> StudentPrograms
        {
            get
            {
                return this.GetTable<StudentProgram>();
            }
        }
